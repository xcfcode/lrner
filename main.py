...
def train(data):
    ...
    if data.optimizer.lower() == "sgd":
        ...
        if data.use_mapping:
            optimizer_wc = optim.Adam(model.word_hidden.wordrep.w.parameters(), lr=data.HP_lr, weight_decay=data.HP_l2)
    else:
...
if __name__ == '__main__':
    ...
    data.HP_gpu = torch.cuda.is_available() and data.HP_gpu
